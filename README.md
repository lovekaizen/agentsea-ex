...
5. **Data plane** 🚧 — Ecto-changeset structured output with a validation-retry loop is done (`agentsea_structured`); Bumblebee embeddings, pgvector memory, and Broadway ingest/evaluate next.
